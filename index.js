...
function randomQuotes() {
  ...
  // const quotes = JSON.stringify(json);
  random_data = quote[Math.floor(Math.random() * quote.length)];
  document.getElementById("title_quote").innerHTML = random_data.text;
  document.getElementById("author").innerHTML = random_data.author;
}
